...
/**
 * A játék osztály. Az alapvetõ input-output feladatokat látja el,
 * õ tartalmazza a program belépési pontját is.
 * 
 * @author TakRaj
 *
 */
public class game {
	...
	/**
	 * Visszaadja a város referenciáját.
	 * 
	 * @return Referencia a városra.
	 */
	...
	/**
	 * Betölti a pályát a file fájlból, ha ez lehetséges.
	 * 
	 * @param file A pályamátrix fájl.
	 * @return Egy város.
	 */
	...
	/**
	 * Betölt egy játékállást file-ból, ha ez lehetséges.
	 * 
	 * @param file A játékállást tartalazó fájl.
	 * @param city Melyik városba töltse be.
	 */
	...
	/**
	 * Kimenti a játékállást file-ba.
	 * 
	 * @param file Kimeneti fájl neve.
	 * @param city Kimentendõ város referenciája.
	 */
	...
	/**
	 * Egyszerû interfész a játékállások betöltésére.
	 * 
	 * @param map Pályamátrix fájl.
	 * @param state Játékállást tartalmazó fájl.
	 */
	...
	/**
	 * Új játék kezdése map pályán. Egyszerûsített interfész.
	 * 
	 * @param map Pályamátrix fájl.
	 */
	...
	/**
	 * Egyszerûsített interfész a játékállás kimentésére.
	 * 
	 * @param file Célfájl.
	 */
	...
	/**
	 * Idõzítõt hoz létre, ami lépteti a várost, majd újrarajzolja a képet.
	 * 
	 * @param interval Milyen idõközönként léptessen.
	 * @param c Melyik várost léptesse.
	 * @param v Mi a város nézete.
	 */
	...
	/**
	 * Egyszerûsített interfész üzenet kiírására a képernyõn.
	 * 
	 * @param s Mit írjon ki.
	 * @return true, ha a felhasználó reagált rá a felületen, vagy konzolra került kiírásra. false, egyébként.
	 */
	...
	/**
	 * Egyszerûsített interfész adatok bekéréséhez a képernyõn.
	 * 
	 * @param s Mi a kérdés?
	 * @return A válasz, vagy "", ha nem adott meg semmit.
	 */
