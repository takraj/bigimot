...
/**
 * Ez a metódus egy nyilat rajzol.
 * 
 * @param g2d Amire rajzolja.
 * @param xCenter Kezdõpont X koordinátája.
 * @param yCenter Kezdõpont Y koordinátája.
 * @param x Végpont X koordinátája.
 * @param y Végpont Y koordinátája.
 * @param stroke Vonalvastagság.
 * 
 * @author TakRaj
 *
 */
